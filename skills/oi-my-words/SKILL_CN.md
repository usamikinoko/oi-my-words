...
name: oi-my-words
description: |
  将用户提供的中文文章草稿去 AI 化改写，
  使其更贴近人类叙述习惯，同时保留原文的内容、结构与表达的意思：
  只调整语句与叙述方式，不重新规划文章结构。
  整体风格严谨且专业：
  以段落叙述为主、少用列表，
  专业术语采用"英文（中文）"标注，
  叙述中点缀低频浅文言过渡短语。
  ...
  例如"请遵循 oi-my-words 规则为我改写……""按 oi-my-words 规范润色……"；
  不点名技能的通用措辞（"去 AI 味""改写""润色""更像人写的"）不得单独触发。
  仅处理已有文本的改写，不承担新文章创作；
  用户要求创作新文章时，应调用 oi-my-words-create。
metadata:
  version: "0.2.0"
  license: "MIT"
---
...
例如"请遵循 oi-my-words 规则为我改写这段文字""按 oi-my-words 规范润色以下内容"。

只描述目的而不点名技能的通用请求（"去 AI 味""改写""润色""更像人写的"）不启用本技能。

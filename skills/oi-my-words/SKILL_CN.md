...
description: |
  ...
  仅限点名触发：只有当请求中明确点名本技能（名称 oi-my-words）时才启用，
  中英文请求均可触发——
  中文如"请遵循 oi-my-words 规则为我改写……"，
  英文如"Rewrite this draft following the oi-my-words guidelines."；
  未点名技能的请求（如"去 AI 味""改写""润色"）不得触发。
  仅处理已有文本的改写，不承担新文章创作；
